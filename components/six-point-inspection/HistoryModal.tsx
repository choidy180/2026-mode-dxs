  ...
  const cornerPreviewItems = selectedLog
    ? [
        ...
        },
        {
          ...
          code: 'CAM 06',
          title: 'Bottom-Left',
          url: selectedLog.images.a6,
        },
        {
          key: 'a5',
          code: 'CAM 05',
          title: 'Bottom-Center',
          url: selectedLog.images.a5,
        },
        {
          key: 'a4',
          code: 'CAM 04',
      ...
      <HistoryModalShell onClick={(event) => event.stopPropagation()}>
        ...
        <HistoryBody>
          <HistorySidebar>
            ...
            <HistoryLogList className="six-point-scrollbar">
          ...
          <HistoryContent className="six-point-scrollbar">
            {selectedLog ? (
              <HistoryDetailStack>
                <HistoryCard>
                  <HistorySelectedHeader>
              ...
              <HistoryEmptyPanel>
                <HistoryEmptyCard>
                  ...
                  <HistoryEmptyText>
                    좌측 목록에서 기록을 선택하면 판정 정보와 확대 영역별 검사 이미지를 확인할 수 있습니다.
                  </HistoryEmptyText>
                </HistoryEmptyCard>
              </HistoryEmptyPanel>
            )}
