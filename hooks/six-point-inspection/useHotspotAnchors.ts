...
import {
  ...
  HOTSPOT_STORAGE_KEY,
} from '@/constants/sixPointInspection';
import type { AnchorMap, AnchorPoint, CornerKey } from '@/types/sixPointInspection';
import { getAnchorMapFromStorageValue, normalizeAnchor } from '@/utils/sixPointInspection';
